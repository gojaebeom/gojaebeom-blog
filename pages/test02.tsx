...
export default function HomePage() {
  return (
    <div>
      <div className="relative bg-gradient-to-r from-[#fa709a] to-[#fee140] h-[100vh] transition-all">
      ...
      <div className="grid w-full grid-cols-3 gap-4">
        ...
        <div className="col-span-3 h-[100vh] relative bg-gradient-to-tr from-[#16a085] to-[#f4d03f]">
